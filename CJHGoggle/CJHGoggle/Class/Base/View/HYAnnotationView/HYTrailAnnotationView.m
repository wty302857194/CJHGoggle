...
@interface HYTrailAnnotationView () {
...
@implementation HYTrailAnnotationView
...
- (id)initWithAnnotation:(id <BMKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self != nil) {
        ...
        frame.size = CGSizeMake(60.0, 24);
        self.frame = frame;
        self.contentMode = UIViewContentModeCenter;
        self.backgroundColor = [UIColor clearColor];
        self.enabled = YES;
        
        self.imageVew.frame = CGRectMake(0, 9, 15, 15);
...
- (void)setImage:(UIImage *)image {
    ...
    self.imageVew.image = [image dp_scaleToSize:CGSizeMake(15, 15)];
}
