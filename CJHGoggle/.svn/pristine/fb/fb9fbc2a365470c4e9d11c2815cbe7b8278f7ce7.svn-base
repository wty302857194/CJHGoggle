...
@property (nonatomic, strong) ZJCustomNoTableView *customNoTableView;
@end
...
- (void)viewDidLoad {
    ...
    [self initBaiDuMap];
    self.customNoTableView.hidden = NO;
}
#pragma mark - 地图初始化
- (void)initBaiDuMap {
...
//    [leftBtn setButtonImageTitleStyle:ButtonImageTitleStyleTop padding:0];
    ...
    [self addNavigationItemWithImageNames:@[@"hy_station_img"] titles:@[@"兴隆洲站"] textClolr:hexColor(323232) isLeft:YES target:self action:@selector(chooseStation) tags:nil];
    
//    HYNavigationItemView *leftBtn = [[[NSBundle mainBundle] loadNibNamed:@"HYNavigationItemView" owner:nil options:nil] lastObject];
//    leftBtn.frame = CGRectMake(0, 0, 45, 45);
//    leftBtn.topImgView.image = [UIImage imageNamed:@"hy_station_img"];
//    leftBtn.bottomLab.text = @"兴隆洲站";
//    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:leftBtn];
...
//    [rightBtn setButtonImageTitleStyle:ButtonImageTitleStyleTop padding:0];
    ...
    [self addNavigationItemWithImageNames:@[@"message_center_index"] titles:@[@"消息"] textClolr:hexColor(323232) isLeft:NO target:self action:@selector(chooseStation) tags:nil];
    
//    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
//    btn.frame = CGRectMake(0, 0, 53, 44);
//    [btn setImage:[UIImage imageNamed:@"message_center_index"] forState:UIControlStateNormal];
//    [btn setTitle:@"消息发的" forState:UIControlStateNormal];
...
//    HYNavigationItemView *rightBtn = [[[NSBundle mainBundle] loadNibNamed:@"HYNavigationItemView" owner:nil options:nil] lastObject];
//    rightBtn.frame = CGRectMake(0, 0, 45, 45);;
//    rightBtn.topImgView.image = [UIImage imageNamed:@"message_center_index"];
//    rightBtn.bottomLab.text = @"消息";
//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:rightBtn];
...
- (ZJCustomNoTableView *)customNoTableView {
    if (!_customNoTableView) {
        
        _customNoTableView = [ZJCustomNoTableView noTableViewWithTitle:@[@"123123123123123",@"123123123123123",@"123123123123123",@"123123123123123",@"123123123123123"] timeArray:@[@"2",@"2",@"2",@"2",@"2"] timeInterval:2 initWithFrame:CGRectMake(10, kLayoutViewMarginTop + 50, kScreenWidth-20, 120)];
        _customNoTableView.hidden = YES;
        [self.view addSubview:_customNoTableView];
    }
    return _customNoTableView;
}
